...
public:
    METHOD_LIST_BEGIN
        ADD_METHOD_TO(ArtistCtrl::get, "/artists/{id}", drogon::Get, "ApiFilter");
        ADD_METHOD_TO(ArtistCtrl::get_all, "/artists", drogon::Get, "ApiFilter");
        ADD_METHOD_TO(ArtistCtrl::create, "/artists", drogon::Post, "ApiFilter");
    METHOD_LIST_END
